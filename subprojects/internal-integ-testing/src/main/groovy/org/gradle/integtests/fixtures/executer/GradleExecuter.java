...
public interface GradleExecuter extends Stoppable {
     ...
     *
     * <p>Note: try to avoid using this method. It has some getMajorVersionNumber drawbacks when it comes to development: 1. It requires a Gradle distribution or installation, and this will need to be rebuilt after
